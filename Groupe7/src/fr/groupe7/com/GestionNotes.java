...
public class GestionNotes {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.print("Nom de l'étudiant (ou 'terminer' pour mettre fin à la liste ) : ");
            String nom = scanner.nextLine();
            if (nom.equalsIgnoreCase("terminer")) {
                break;
            }
